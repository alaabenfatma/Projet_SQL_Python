...
class AppRepLibre(QDialog):

    # Constructeur
    def __init__(self, data:sqlite3.Connection):
        super(QDialog, self).__init__()
        self.ui = uic.loadUi("gui/rep_libre_2_1.ui", self)
        self.data = data
        self.refreshResult()
    ...
    def refreshResult(self):
        ...
        try:
            ...
            result = cursor.execute("SELECT noSpec, dateRep, promoRep  FROM lesrepresentations where nbPlacesDispoRep = (select count(*) from lesplaces)")
            display.refreshLabel(self.ui.label_fct_comp_1, "")
