...
class AppWindow(QMainWindow):
    ...
    def open_res_edit(self):
        if self.res_edit_dialog is not None:
            self.res_edit_dialog.close()
        self.res_edit_dialog = AppResEdit(self.data)
        self.res_edit_dialog.show()
